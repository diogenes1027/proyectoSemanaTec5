...
export default {
    ...
    methods:{
        async agregarTodo(){
            await this.axios.post('https://backendst5.herokuapp.com/todo',this.newTodo).then((response)=>{
        ...
        async finalizarTodo(id){
            await this.axios('https://backendst5.herokuapp.com/todo/complete/'+id).then((response)=>{
                console.log(response)
                this.cargarTodos();
            })
        },
        cargarTodos(){
            this.axios('https://backendst5.herokuapp.com/todo/list').then((response)=>{
